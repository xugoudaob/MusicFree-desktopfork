 ...
 *
 * 透明窗口（WS_EX_LAYERED + WS_EX_TRANSPARENT）的 WM_NCHITTEST 会返回 HTTRANSPARENT，
 * 导致鼠标消息被穿透到下层窗口。解决：设置 WS_EX_LAYERED 但不设 WS_EX_TRANSPARENT，
 * 同时通过 setIgnoreMouseEvents 的前向转发来控制点击穿透行为。
 *
